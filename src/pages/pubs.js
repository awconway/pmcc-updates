...
const pubs = [
  ...
  {
    title:
      "Midazolam for sedation before procedures: A systematic review update",
  ...
  {
    title:
      "Accuracy of continuous non-invasive arterial pressure monitors: A systematic review & meta-analysis",
